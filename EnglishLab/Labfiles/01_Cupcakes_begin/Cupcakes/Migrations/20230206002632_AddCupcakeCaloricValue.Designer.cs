...
namespace Cupcakes.Migrations
{
    ...
    [Migration("20230206002632_AddCupcakeCaloricValue")]
            ...
            modelBuilder.Entity("Cupcakes.Models.Cupcake", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { CupcakeId = 2, BakeryId = 2, CaloricValue = 195, CupcakeType = 2, Description = "VChocolate cupcake with caramel filling and chocolate butter cream", GlutenFree = false, ImageMimeType = "image/jpeg", ImageName = "chocolate-cupcake.jpg", Price = 3.2 },
